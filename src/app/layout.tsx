...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const iconVersion = "v20260329-1"; // Cache-Bust für neue Favicons
  ...
  return {
    ...
    icons: [
      ...
      { rel: "icon", url: `/mmfavicon-20260329-32x32.png?${iconVersion}`, type: "image/png", sizes: "32x32" },
      { rel: "icon", url: `/mmfavicon-20260329-16x16.png?${iconVersion}`, type: "image/png", sizes: "16x16" },
      { rel: "icon", url: `/mmfavicon-20260329-48x48.png?${iconVersion}`, type: "image/png", sizes: "48x48" },
      { rel: "icon", url: `/mmfavicon-20260329.png?${iconVersion}`, type: "image/png", sizes: "512x512" },
      { rel: "shortcut icon", url: `/mmfavicon-20260329.ico?${iconVersion}` },
      { rel: "apple-touch-icon", url: `/mmapple-touch-icon-20260329.png?${iconVersion}`, sizes: "180x180" },
