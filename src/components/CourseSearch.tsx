...
export default function CourseSearch({ variant = "default" }: { variant?: Variant }) {
  ...
  return (
    <div className="relative">
      ...
      {results.length > 0 && (
        <div className="absolute left-1/2 -translate-x-1/2 w-[90vw] max-w-[calc(100vw-24px)] sm:left-0 sm:right-0 sm:w-auto sm:max-w-none sm:translate-x-0 mt-2 rounded-2xl border border-slate-200 bg-white shadow-2xl shadow-slate-300/50 overflow-hidden z-50">
